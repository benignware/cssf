...
const { ifelse, gt, divide, add, rgba, hsla } = require('..');
const luminance = require('./luminance');
const { toPrecision, parseFn } = require('../utils');
...
describe('luminance', () => {
  ...
  xit('can be derived a contrast ratio between colors by their luminance', () => {
  ...
  xit('can be derived a contrast ratio between colors by their luminance dynamically', () => {
    const rgb1 = 'rgb(25, 255, 255)';
    const rgb2 = 'rgb(255, 55, 200)';
  ...
  xit('can be derived a contrast color from contrast ratio based on luminance', () => {
