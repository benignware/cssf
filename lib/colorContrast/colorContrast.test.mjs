...
describe('colorContrast', () => {
  ...
  xit('computes dark contrast color from mixed color', () => {
    ...
    // const mixed = colorMix('in srgb', rgb1_w1, rgb2_w2);
    const mixed = `colorMix(in srgb, ${rgb1_w1}, ${rgb2_w2})`;
    // console.log('MIXED: ', mixed);
    const mixed_eval = evaluate(mixed);

    // console.log('MIXED: ', mixed, mixed_eval);
    
    const actual = colorContrast(mixed, '#fff', '#000');
