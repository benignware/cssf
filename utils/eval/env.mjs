export * as ENV_2022 from './env/env2022.mjs';
export * as ENV_2023 from './env/env2023.mjs';
export * as ENV_2024 from './env/env2024.mjs';
export * as ENV_NEXT from './env/envNext.mjs';

// export * from './env/env-24.mjs';
