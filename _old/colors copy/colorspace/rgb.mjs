...
// Gamma correction functions for sRGB
...
// Gamma correction functions for A98-RGB
...
// Linear RGB Conversion Functions
export function srgbToRgbLinear(r, g, b) {
  [r, g, b] = [r / 255, g / 255, b / 255];
  return gammaToLinear(r, g, b);
}

export function rgbLinearToSrgb(r, g, b) {
  return [
    Math.round(clamp(INV_GAMMA_SRGB(r) * 255, 0, 255)),
    Math.round(clamp(INV_GAMMA_SRGB(g) * 255, 0, 255)),
    Math.round(clamp(INV_GAMMA_SRGB(b) * 255, 0, 255))
  ];
}
...
export function xyzToA98Rgb(x, y, z) {
  let [r, g, b] = matrixMultiply(MATRIX_XYZ_TO_A98RGB, x, y, z);
  [r, g, b] = linearToGamma(r, g, b);
  return [
    Math.round(clamp(r * 255, 0, 255)),
    Math.round(clamp(g * 255, 0, 255)),
